      ...
      <div className="rectangle-div container-fluid">
          ...
          <div className="this-is-the-container">
            <p className="this-is-the">
              This is the right place if you are in search for the best women outfits.
              Let’s redefine your styling{" "}
            </p>
            <p className="this-is-the">
              system with our huge store of trendy particulars. You can take online at
              us from the comfort of
            </p>
            <p className="this-is-the">
              {" "}
            ...
            <div className="imgvector position-absolute">
              <img className="vector-box1" alt="" src={group5} />
                <div className="we-believe-every-container">
                  ...
                  <b>design decision</b>
                  <span> should be measured by its ability to help you reach actual </span>
                  <b>business goals</b>
                </div>
            ...
            <img className="vector-box2" alt="" src={group4} />
                <div className="technology-is-a-container">
                  <span>
                    Technology is a double-edged sword : we take into account your current{" "}
                  </span>
                  <b>capabilities</b>
                  <span> and </span>
                  <b>limitations</b>
